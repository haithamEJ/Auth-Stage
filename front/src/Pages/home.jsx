        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            <div className="bg-gray-800 px-6 py-8 text-white">
              <h1 className="text-3xl md:text-4xl font-bold mb-2">Welcome to my Website</h1>
              <p className="text-gray-300">Oui Oui</p>
            </div>
            ...
            <div className="p-6 md:p-8">
              ...
              <div className="border-t border-gray-200 pt-6">
                <h3 className="text-xl font-medium text-gray-800 mb-4">Test1</h3>
                <div className="grid md:grid-cols-3 gap-4">
                  <div className="p-4 bg-gray-50 rounded-lg">
                    ...
                    <h4 className="font-medium text-gray-800 mb-1">Test2</h4>
                    <p className="text-sm text-gray-600">Je sais pas</p>
                  </div>
                  <div className="p-4 bg-gray-50 rounded-lg">
                    <div className="w-10 h-10 bg-gray-700 rounded-full flex items-center justify-center mb-3">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-white" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <h4 className="font-medium text-gray-800 mb-1">Test3</h4>
                    <p className="text-sm text-gray-600">Baleine</p>
                  </div>
                  <div className="p-4 bg-gray-50 rounded-lg">
                    <div className="w-10 h-10 bg-gray-700 rounded-full flex items-center justify-center mb-3">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-white" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <h4 className="font-medium text-gray-800 mb-1">Test4</h4>
